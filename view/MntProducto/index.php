...
<html lang="en">
  <head>
    ...
    <link href="../../publiclib/Ionicons/css/ionicons.css" rel="stylesheet">
    <link href="../../publiclib/perfect-scrollbar/css/perfect-scrollbar.css" rel="stylesheet">
    <link href="../../publiclib/jquery-switchbutton/jquery.switchButton.css" rel="stylesheet">
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="../MntProducto/index.php" class="nav-link">Prodcuto</a></li>
        </ul>
